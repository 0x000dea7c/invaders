...
namespace Game {
  ...
  // };
  //
  // inline Menu_Option& operator++(Menu_Option& m)
  // {
  //   switch(m) {
  //     case Menu_Option::PLAY:
  //       return m = Menu_Option::SOUND;
  //     case Menu_Option::SOUND:
  //       return m = Menu_Option::EXIT;
  //     case Menu_Option::EXIT:
  //       return m = Menu_Option::PLAY;
  //     default:
  //       assert(false && "operator++ menu_option, not implemented");
  //   }
  // }
  //
  // inline Menu_Option& operator--(Menu_Option& m)
...
/*
  struct Invaders final {
    ...
    u32 current_level{ 0 };
    Menu_Option current_menu_option{ Menu_Option::PLAY };
    u32 max_levels{ 4 };

...
* TODO Save points and table scoreboard when player loses/wins
 - in here, if new score is in top 5, print it as yellow
* TODO Audio device selection in window not in console
* TODO change explosion and win game sound
* TODO Power-ups?

...
* TODO add new crashed UFO that goes diagonally down and if it touches the player it both die
* TODO add alien w/ some explosive attached to it that when you destroy it, it clears the whole level
 it spawn every now and then
* TODO Improve visuals!!!!!!!!!!!!!!!!! (idk not creative), background sucks, maybe another explosion tex?
  - animations?
  - new song for when an ufo appears and is destroyed
  - bg very slowly moves, not many stars, add planets?

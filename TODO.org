...
* TODO rotate roswell to make it look crashed?
* TODO now that you're doing rotations... can't you use matrices to hold the position?
* DONE Change initial game screen image
* TODO maybe another explosion tex?
* TODO clean some todos and run static analyzer + iwyu
* TODO padding issues everywhere, sure of it! need to fix, but how? why is that even a problem? investigate.-....

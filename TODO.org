...
* TODO Game units
* TODO Improve aliens' AI, rn it's crap -> it also has movement bugs!
* TODO Power-ups?
* TODO Try to fix tunneling
  you also need to fix weird intersection tests when the ship is at the very bottom
...
* TODO do you really need to decrease --i; when you remove missiles and enemies?
* TODO fix bug with scoreboard, all of sudden and rQ appears???
